...
from tabsyn.latent_utils import get_input_generate, recover_data, split_num_cat_target, split_num_cat_target_my
...
def main(args):
    ...
    syn_num, syn_cat, syn_target = split_num_cat_target_my(syn_data, info, num_inverse, cat_inverse)
